...
SETTINGS_CATALOG: tuple[SettingDefinition, ...] = (
    ...
    SettingDefinition(
        key="pim_xlsx",
        label="PIM Dataset Path",
        category="Catalog",
        description="Path to the main PIM Excel dataset imported at startup.",
        env_name="PIM_XLSX",
        multiline=True,
        restart_required=True,
        immediate_apply=False,
        placeholder="data/PIM_20260224.xlsx",
    ),
    SettingDefinition(
        key="family_map_xlsx",
        label="Family Map Path",
        category="Catalog",
        description="Path to the family map Excel used during product import.",
        env_name="FAMILY_MAP_XLSX",
        multiline=True,
        restart_required=True,
        immediate_apply=False,
        placeholder="data/family_map.xlsx",
    ),
    SettingDefinition(
        key="pim_verbose",
        label="Verbose PIM Import",
        category="Catalog",
        description="Enable verbose logging during PIM import operations.",
        env_name="PIM_VERBOSE",
        placeholder="true or false",
    ),
    SettingDefinition(
