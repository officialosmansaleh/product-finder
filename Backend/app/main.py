...
def _df_filtered_subset(df: pd.DataFrame, filters: Dict[str, Any]) -> pd.DataFrame:
    ...
    for col in ["control_protocol", "interface", "insulation_class", "surge_common_mode", "emergency_present", "mounting_type", "shape", "housing_material", "housing_color", "product_family", "manufacturer"]:
        if col in filters:
...
_COMPARE_FIELD_PRIORITY = [
    ...
    "control_protocol", "interface", "insulation_class", "surge_common_mode", "emergency_present",
